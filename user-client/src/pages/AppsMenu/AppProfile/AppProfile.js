...
import profile02 from "../../../images/pages/serviceimage.jpg";
import profile03 from "../../../images/pages/aboutimage.jpg";
...
//   const {aboutMe,countryLiving,currentLocation,occupation,annualIncome,nativePlace,diet,smoking,drinking, family,education,residential,contact } =userProfile;
  ...
  const [image, setimage] = useState('')
	...
	if (loading) {
		...
		const { fullName, email, dob, address, mobile } = userProfile;
  ...
  return (
                ...
                <div className="custom-tab-1">
						<ul className="nav nav-tabs">
							...
							<li className="nav-item" onClick={() => setActiveToggle("basicProfile")}>
								<Link to="#basic-profile"  data-toggle="tab" className={`nav-link ${ activeToggle === "basicProfile" ? "active show" : ""}`}>Profile</Link>
							</li>
							...
							<Card>
								...
								<Card.Body>
									...
									<strong> Edit Your Basic Profile</strong>{" "} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											...
											<Link style={{color:"white"}} to="/form-edit-profile">
	...
	return(
		...
		<Col xl={6} className="col-xxl-12">
			<Card>
				<Card.Body>
					<Link to="/form-add-profile"> Click Here to Fill up Profile </Link>
				</Card.Body>
